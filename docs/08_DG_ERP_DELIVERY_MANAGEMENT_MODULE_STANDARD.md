...
Delivery Ready → Employee Opens Delivery → Packing → Delivery Processing
→ Customer Receives Goods → Customer Signature → Photo Attachment →
Document Attachment → Submit Delivery → Delivery Completed → PDF
