...
trait CreatesCompanyRouteTestFoundation
{
    ...
    protected function createCompanyRouteTestSchema(): void
    {
        ...
        Schema::create('sales_return_items', function (Blueprint $table): void {$table->id();$table->unsignedBigInteger('company_id');$table->unsignedBigInteger('financial_year_id');$table->unsignedBigInteger('sales_return_id');$table->unsignedBigInteger('sales_item_id');$table->unsignedBigInteger('product_id')->nullable();$table->unsignedBigInteger('service_id')->nullable();$table->decimal('quantity',20,6);foreach(['unit_price','vat_rate','vat_amount','total_price'] as $column)$table->decimal($column,20,4)->default(0);$table->decimal('fiscal_discount_amount',20,4)->nullable();$table->decimal('fiscal_net_base',20,4)->nullable();$table->string('tax_classification')->default('legacy_unclassified');$table->unsignedBigInteger('created_by')->nullable();$table->boolean('status')->default(true);$table->timestamps();});
