...
class CbmsPhaseOneFoundationTest extends TestCase
{
    ...
    public function test_credit_note_uses_original_reference_own_amounts_date_and_reason(): void
    {
        ...
        CbmsTransmission::create(['company_id' => $this->company->id, 'transmittable_type' => $invoice->getMorphClass(), 'transmittable_id' => $invoice->id, 'endpoint_type' => CbmsTransmission::ENDPOINT_BILL, 'status' => CbmsTransmission::STATUS_SUBMITTED, 'attempt_count' => 1, 'payload_hash' => str_repeat('a', 64), 'submitted_at' => now()]);
