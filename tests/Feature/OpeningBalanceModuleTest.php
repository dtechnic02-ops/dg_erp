...
class OpeningBalanceModuleTest extends TestCase
{
    protected function setUp(): void
    {
        ...
        Schema::create('users', fn (Blueprint $t) => [$t->id(),$t->string('name'),$t->string('email')->nullable(),$t->string('password')->nullable(),$t->unsignedBigInteger('company_id'),$t->unsignedBigInteger('role_id')->nullable(),$t->string('account_status')->default('active'),$t->rememberToken(),$t->timestamps()]);
