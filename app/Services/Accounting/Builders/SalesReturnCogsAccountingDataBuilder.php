...
class SalesReturnCogsAccountingDataBuilder
{
    public function build(SalesReturn $return): array
    {
        ...
        return ['company_id' => $return->company_id, 'financial_year_id' => $return->financial_year_id, 'entry_date' => $date, 'reference_number' => $return->return_no, 'source_module' => 'sales_return_cogs', 'source_type' => 'sales_return_cogs', 'source_id' => $return->id, 'source_event' => 'created', 'source_key' => 'sales-return-cogs:' . $return->id . ':created', 'description' => 'Sales return inventory restoration - ' . $return->return_no, 'posted_by' => $return->created_by, 'lines' => [
