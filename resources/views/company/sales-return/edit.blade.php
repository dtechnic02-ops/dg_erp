...
<div class="dg-page">
    ...
    <main class="dg-container">
        <div class="container-fluid">
            ...
            <form id="dgForm" method="POST" action="{{ route('company.sales-return.update', $return->id) }}" class="dg-form">
                @csrf
                ...
                <section class="dg-section">
                    <article class="card dg-card">
                        ...
                        <div class="card-body dg-card-body">
                            <div class="row g-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" id="customer_name" class="form-control dg-input" value="{{ $return->customer->name ?? '-' }}" readonly>
                                </div>
                                <div class="col-md-4">
                        ...
                        <footer class="card-footer dg-card-footer">
                            ...
                            <a href="{{ route('company.sales-return.show', $return->id) }}" class="btn btn-outline-secondary dg-btn">Cancel</a>
                        </footer>
                    </article>
                </section>
            </form>
