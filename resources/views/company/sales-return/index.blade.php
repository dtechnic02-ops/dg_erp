...
<div class="dg-page">
            ...
            <div class="d-flex flex-nowrap align-items-center gap-2">
                ...
                <div class="flex-fill d-flex justify-content-end align-items-center gap-2 flex-wrap flex-md-nowrap">
                    ...
                    <nav class="btn-group" aria-label="Sales return toolbar">
                        ...
                        <a href="{{ route('company.sales-return.index') }}" class="btn btn-outline-secondary dg-btn">Refresh</a>

                        <a href="{{ route('company.sales-return.index', array_merge(request()->query(), ['print' => 1])) }}" target="_blank" class="btn btn-outline-secondary dg-btn">Print List</a>
    ...
    <main class="dg-container">
        ...
        <div class="container-fluid">
            ...
            <section class="dg-section dg-filter">
                ...
                <article class="card dg-card">
                    ...
                    <div class="card-body dg-card-body dg-filter-card-body">
                        ...
                        <form method="GET" action="{{ route('company.sales-return.index') }}" class="dg-filter-form">
                            ...
                            <div class="dg-filter-grid">
                                ...
                                <div class="dg-filter-field dg-filter-field-actions">
                                    ...
                                    <div class="dg-filter-actions">
                                        ...
                                        <a href="{{ route('company.sales-return.index') }}" class="btn btn-outline-secondary dg-btn dg-filter-btn">Reset</a>
            ...
            <section class="dg-section" id="dgSalesReturnList">

                <article class="card dg-card dg-print">

                    <header class="card-header dg-card-header dg-list-card-header">

                        <h2 class="dg-list-card-title">Sales Return List</h2>



                        <form method="GET" action="{{ route('company.sales-return.index') }}" class="dg-list-per-page">
                                ...
                                <tbody class="dg-body">
                                        ...
                                        <tr class="dg-row">
                                            ...
                                            <td class="dg-action-col">
                                                ...
                                                <div class="dg-action-group" role="group" aria-label="Return actions for {{ $return->return_no }}">
                                                    ...
                                                    <a href="{{ route('company.sales-return.show', $return->id) }}" class="btn btn-sm btn-outline-primary dg-action-btn">View</a>

                                                    @if ((float) $return->remaining_amount > 0)

                                                        <a href="{{ route('company.sales-return-refund.create', $return->id) }}" class="btn btn-sm btn-outline-warning dg-action-btn">Refund</a>

                                                    @endif

                                                    @if ((int) $return->status === 1 && $return->refund_status === 'Unpaid')

                                                        <button type="button" class="btn btn-sm btn-outline-danger dg-action-btn" data-bs-toggle="modal" data-bs-target="#dgSalesReturnCancelModal{{ $return->id }}">Cancel</button>
                                    ...
                                    @empty
                                        ...
                                        <tr class="dg-row">
                                            ...
                                            <td colspan="13" class="text-center">No sales returns found.</td>
            ...
            @foreach ($returns as $return)
                @if ((int) $return->status === 1 && $return->refund_status === 'Unpaid')
                    @include('company.partials.dg-sales-cancel-modal', [
                        'modalId' => 'dgSalesReturnCancelModal' . $return->id,
        ...
        @push('scripts')
            <script>
                document.addEventListener('DOMContentLoaded', function () {
                    var modalEl = document.getElementById('dgSalesReturnCancelModal{{ old('cancel_entity_id') }}');
