...
@section('title', 'Edit Purchase Return Refund')
...
<div class="dg-page">
    ...
    <header class="dg-toolbar">
        <div class="container-fluid">
            <div class="row align-items-center g-2">
                <div class="col">
                    <h1 class="h4 mb-0">Edit Purchase Return Refund</h1>
                </div>
                <div class="col-auto">
                    <nav class="btn-group" aria-label="Purchase return refund toolbar">
                        <a href="{{ route('company.purchase-return-refunds.index') }}" class="btn btn-outline-secondary dg-btn">Refund List</a>
                        <a href="{{ route('company.purchase-return-refunds.show', $refund->id) }}" class="btn btn-outline-secondary dg-btn">View Refund</a>
                    </nav>
                </div>
            </div>
        </div>
    ...
    <main class="dg-container">
        <div class="container-fluid">
            ...
            <form id="dgForm" method="POST" action="{{ route('company.purchase-return-refunds.update', $refund->id) }}" class="dg-form">
                @csrf
                ...
                <section class="dg-section">
                    <article class="card dg-card">
                        ...
                        <div class="card-body dg-card-body">
                            <div class="row g-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" id="supplier_name" class="form-control dg-input" value="{{ $refund->supplier->name ?? '-' }}" readonly>
                                </div>
                                <div class="col-md-4">
                                    <label class="form-label" for="return_no">Return No</label>
                                    <input type="text" id="return_no" class="form-control dg-input" value="{{ $refund->purchaseReturn->return_no ?? '-' }}" readonly>
                                </div>
                                <div class="col-md-4">
                        ...
                        <footer class="card-footer dg-card-footer">
                            ...
                            <a href="{{ route('company.purchase-return-refunds.show', $refund->id) }}" class="btn btn-outline-secondary dg-btn">Cancel</a>
                        </footer>
                    </article>
                </section>
            </form>
