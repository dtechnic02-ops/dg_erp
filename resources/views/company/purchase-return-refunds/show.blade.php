        ...
        <div class="container-fluid">
            <div class="d-flex flex-nowrap align-items-center justify-content-end gap-2">
                <nav class="btn-group" aria-label="Purchase return refund toolbar">
                    ...
                    @if ($refund->isActive())
                        <a href="{{ route('company.purchase-return-refunds.edit', $refund->id) }}" class="btn btn-outline-primary dg-btn">Edit</a>
                    @endif
                    @if ($purchaseReturn)
                        ...
                        @if ($refund->attachment)
                            <div class="dg-invoice-note-block d-print-none">
                                ...
                                <div class="dg-invoice-note-body">
                                    <a href="{{ route('company.protected-files.show', ['purchase-return-refund', $refund->id, 'attachment']) }}" target="_blank" rel="noopener">View Attachment</a>
                                </div>
                            </div>
                        @endif
                    </section>
