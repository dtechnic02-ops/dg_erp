...
<div class="dg-page">
    ...
    <header class="dg-toolbar">
        <div class="container-fluid">
            <div class="row align-items-center g-2">
                <div class="col">
                    <h1 class="h4 mb-0">Create Sales Return Refund</h1>
                    <p class="text-muted small mb-0">Settle sales return via invoice adjustment and optional refund to customer</p>
                </div>
                <div class="col-auto">
                    <nav class="btn-group" aria-label="Sales return refund create toolbar">
                        <a href="{{ route('company.sales-return-refund.index') }}" class="btn btn-outline-secondary dg-btn">Back</a>
                        <a href="{{ route('company.sales-return.show', $return->id) }}" class="btn btn-outline-secondary dg-btn">View Return</a>
                    </nav>
                </div>
            </div>
        </div>
    ...
    <main class="dg-container">
        <div class="container-fluid">
            ...
            <form method="POST" action="{{ route('company.sales-return-refund.store') }}" enctype="multipart/form-data" id="dgSalesReturnRefundForm"
                        ...
                        <section class="dg-section">
                            <article class="card dg-card mb-3">
                                <header class="card-header dg-card-header">
                                    <h2 class="h6 mb-0">Sales Return Information</h2>
                                </header>
                                <div class="card-body dg-card-body">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-12 col-md-4">
                                            ...
                                            <input type="text" id="customer_display" class="form-control dg-input" value="{{ $return->customer->name ?? '-' }}" readonly>
                                        </div>
                                            ...
                                            <tbody class="dg-body">
                                                @forelse ($outstandingInvoices as $invoice)
                                                    <tr class="dg-row">
                                                        ...
                                                        <td>{{ $invoice->sale_date ? \Illuminate\Support\Carbon::parse($invoice->sale_date)->format('d-m-Y') : '-' }}</td>
                                ...
                                <div class="card-body dg-card-body">
                                    <div class="row g-3">
                                        <div class="col-12 col-md-6">
                                            <label for="cash_amount" class="form-label">Refund To Customer <span class="text-muted">(Optional)</span></label>
                                            <input type="number"
                                                step="0.01"
                                                min="0"
                                                max="{{ $remainingAmount }}"
                                ...
                                <div class="card-body dg-card-body">
                                    <table class="table table-sm mb-3">
                                        <tbody>
                                            ...
                                            <tr>
                                                <th scope="row">Refund To Customer</th>
