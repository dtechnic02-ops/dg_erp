...
@section('title', 'Sales Return Refund Details')
...
<div class="dg-page dg-invoice">
            ...
            <div class="d-flex flex-nowrap align-items-center justify-content-end gap-2">
                <nav class="btn-group" aria-label="Sales return refund toolbar">
                    ...
                    @if ((int) $refund->status !== 0)
                        <button type="button" class="btn btn-outline-danger dg-btn" data-bs-toggle="modal" data-bs-target="#dgSalesReturnRefundCancelModal">Cancel Refund</button>
                    @endif
                </nav>
            </div>
        </div>
    ...
    @if ((int) $refund->status !== 0)
        @include('company.partials.dg-sales-cancel-modal', [
            'modalId' => 'dgSalesReturnRefundCancelModal',
    ...
    <main class="dg-container">
        <div class="container-fluid">
            ...
            <article class="dg-invoice-sheet dg-print">
                ...
                <h1 class="dg-invoice-doc-title">SALES RETURN REFUND</h1>
    ...
    @push('scripts')
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                var modalEl = document.getElementById('dgSalesReturnRefundCancelModal');
