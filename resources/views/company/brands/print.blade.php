...
<body onload="window.print()">
    ...
    <div class="container-fluid">
        ...
        <table>
            ...
            <tbody>
                @forelse ($brands as $index => $b)
                    <tr>
                        ...
                        <td>{{ $b->name }}</td>
                        <td>{{ $b->description }}</td>
                        <td class="text-center">{{ $b->status ? 'Active' : 'Inactive' }}</td>
                    </tr>
                @empty
                    <tr>
            ...
            <tfoot>
                <tr>
                    <td colspan="3" class="text-end"><strong>Total Brands</strong></td>
                    <td class="text-center"><strong>{{ $totalBrands }}</strong></td>
                </tr>
            </tfoot>
        </table>
