...
@section('title', 'Edit Sales Payment')
...
<div class="dg-page">
    ...
    <header class="dg-toolbar">
        <div class="container-fluid">
            <div class="row align-items-center g-2">
                <div class="col">
                    <h1 class="h4 mb-0">Edit Sales Payment</h1>
                </div>
                <div class="col-auto">
                    <nav class="btn-group" aria-label="Sales payment toolbar">
                        <a href="{{ route('company.sales-payment.index') }}" class="btn btn-outline-secondary dg-btn">Payment List</a>
                        <a href="{{ route('company.sales-payment.show', $payment->id) }}" class="btn btn-outline-secondary dg-btn">View Payment</a>
                    </nav>
                </div>
            </div>
        </div>
    ...
    <main class="dg-container">
        <div class="container-fluid">
            ...
            <form id="dgForm" method="POST" action="{{ route('company.sales-payment.update', $payment->id) }}" class="dg-form">
                @csrf
                ...
                <section class="dg-section">
                    <article class="card dg-card">
                        ...
                        <div class="card-body dg-card-body">
                            <div class="row g-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" id="customer_name" class="form-control dg-input" value="{{ $payment->customer->name ?? '-' }}" readonly>
                                </div>
                                <div class="col-md-4">
                                    <label class="form-label" for="invoice_no">Invoice No</label>
                                    <input type="text" id="invoice_no" class="form-control dg-input" value="{{ $payment->salesInvoice->invoice_no ?? '-' }}" readonly>
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" id="paid_amount" class="form-control dg-input text-end" value="{{ number_format($payment->paid_amount, 2) }}" readonly>
                                </div>
                                <div class="col-md-3">
                        ...
                        <footer class="card-footer dg-card-footer">
                            ...
                            <a href="{{ route('company.sales-payment.show', $payment->id) }}" class="btn btn-outline-secondary dg-btn">Cancel</a>
                        </footer>
                    </article>
                </section>
            </form>
