...
<div class="dg-page">
    ...
    <header class="dg-toolbar">
        <div class="container-fluid">
            <div class="row align-items-center g-2">
                <div class="col">
                    <h1 class="h4 mb-0">Edit Income Category</h1>
                </div>
                <div class="col-auto">
    ...
    <main class="dg-container">
        <div class="container-fluid">
            ...
            <form method="POST" action="{{ route('company.income-category.update', $category->id) }}" class="dg-form">
                @csrf
                        ...
                        <div class="card-body dg-card-body">
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="code" id="code" class="form-control dg-input" value="{{ old('code', $category->code) }}">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label" for="chart_account_id">Income Chart Account <span class="text-danger">*</span></label>
                                    <select name="chart_account_id" id="chart_account_id" class="form-select dg-select" required>
                                        <option value="">Select Income Chart Account</option>
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea name="note" id="note" rows="3" class="form-control dg-input">{{ old('note', $category->note) }}</textarea>
                                </div>
                            </div>
                        </div>
