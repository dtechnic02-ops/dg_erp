        ...
        <div class="container-fluid">
            ...
            <section class="dg-section dg-summary mb-2">
                <div class="row dg-row g-2">
                    @foreach (['Income' => $report['income'], 'Expense' => $report['expense'], $report['result'] => $report['net']] as $label => $value)
            ...
            <section class="dg-section">
                <article class="card dg-card dg-print">
                    <header class="card-header dg-card-header dg-list-card-header">
                        <h2 class="dg-list-card-title">Profit &amp; Loss</h2>
                    </header>
                        ...
                        <div class="dg-table-scroll">
                            <table class="table dg-table dg-table-compact">
                                ...
                                <tbody class="dg-body">
                                    ...
                                    @empty
                                        <tr class="dg-row">
                                            <td colspan="4" class="text-center">No Profit &amp; Loss activity.</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                            </table>
