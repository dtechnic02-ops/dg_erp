...
<meta charset="UTF-8">
<title>Supplier List - Print</title>
...
<div class="container-fluid">
    ...
    <h5 class="text-center fw-bold mb-2">SUPPLIER LIST</h5>
        ...
        <tbody>
            ...
            @forelse ($suppliers as $s)
                <tr>
                    ...
                    <td>{{ $s->mobile ?: '-' }}</td>
                    <td>{{ $s->email ?: '-' }}</td>
                    <td class="text-end">{{ number_format($s->current_balance, 2) }}</td>
    ...
    <table class="table table-sm table-bordered mb-2">
        <tbody>
            <tr>
                <th class="w-25">Total Suppliers</th>
    ...
    <div class="row border-top pt-2 mt-2 text-muted">
        ...
        <div class="col-4 text-end">Total Records: {{ $suppliers->count() }}</div>
    </div>
