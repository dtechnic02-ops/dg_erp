...
<div class="dg-page">
    ...
    <header class="dg-toolbar">
        <div class="container-fluid">
            <div class="row align-items-center g-2">
                <div class="col">
                    <h1 class="h4 mb-0">Make Purchase Payment</h1>
                    <p class="text-muted small mb-0">Pay supplier invoice</p>
                </div>
                <div class="col-auto">
                    <nav class="btn-group" aria-label="Purchase payment create toolbar">
    ...
    <main class="dg-container">
        <div class="container-fluid">
            ...
            <form method="POST" action="{{ route('company.purchase-payments.store') }}" enctype="multipart/form-data" id="dgPurchasePaymentForm">
                @csrf
                                ...
                                <div class="card-body dg-card-body">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="number" step="0.01" name="amount" id="paid_amount" class="form-control dg-input" value="{{ old('amount', $remainingAmount) }}" max="{{ $remainingAmount }}" data-remaining="{{ $remainingAmount }}" required>
                                        </div>
                                        <div class="col-md-6">
...
@push('scripts')
    <script>
        if (window.DG && DG.purchasePayment) {
            DG.purchasePayment.init();
        }
    </script>
@endpush
