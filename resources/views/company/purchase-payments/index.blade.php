...
<div class="dg-page">
            ...
            <div class="d-flex flex-nowrap align-items-center gap-2">
                ...
                <div class="flex-fill d-flex justify-content-end align-items-center gap-2 flex-wrap flex-md-nowrap">
                    <nav class="btn-group" aria-label="Purchase payment toolbar">
                        ...
                        <a href="{{ route('company.purchases.index') }}" class="btn btn-primary dg-btn">New Payment</a>
                        <a href="{{ route('company.purchase-payments.index') }}" class="btn btn-outline-secondary dg-btn">Refresh</a>
                        <a href="{{ route('company.purchase-payments.print-list', request()->query()) }}" target="_blank" class="btn btn-outline-secondary dg-btn">Print List</a>
    ...
    <main class="dg-container">
        <div class="container-fluid">
            ...
            <section class="dg-section dg-filter @if (request('print')) d-print-none @endif">
                <article class="card dg-card">
                    ...
                    <div class="card-body dg-card-body dg-filter-card-body">
                        <form method="GET" action="{{ route('company.purchase-payments.index') }}" class="dg-filter-form">
                            <div class="dg-filter-grid">
                                ...
                                <div class="dg-filter-field dg-filter-field-actions">
                                    ...
                                    <div class="dg-filter-actions">
                                        ...
                                        <a href="{{ route('company.purchase-payments.index') }}" class="btn btn-outline-secondary dg-btn dg-filter-btn">Reset</a>
                                    </div>
                                </div>
            ...
            <section class="dg-section" id="dgPurchasePaymentList">
                <article class="card dg-card dg-print">
                    <header class="card-header dg-card-header dg-list-card-header">
                        <h2 class="dg-list-card-title">Purchase Payment List</h2>

                        <form method="GET" action="{{ route('company.purchase-payments.index') }}" class="dg-list-per-page @if (request('print')) d-print-none @endif">
                            ...
                            <table class="table dg-table dg-table-compact">
                                <thead class="dg-head">
                                    <tr>
                                        ...
                                        <th scope="col" class="dg-col-num dg-col-paid">Payment Amount</th>
                                        ...
                                        <tr class="dg-row">
                                            ...
                                            <td class="dg-action-col d-print-none">
                                                <div class="dg-action-group" role="group" aria-label="Payment actions for {{ $payment->payment_no }}">
                                                    <a href="{{ route('company.purchase-payments.show', $payment->id) }}" class="btn btn-sm btn-outline-primary dg-action-btn">View</a>
                                                </div>
                                            </td>
                                        </tr>
                                    @empty
