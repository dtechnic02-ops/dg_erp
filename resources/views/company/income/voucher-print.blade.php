...
@section('title', 'Income Voucher Print')
            ...
            <div id="printArea">
                <article class="card dg-card dg-payment">
                    ...
                    <header class="text-center border-bottom pb-2 mb-2">
                        ...
                        @endif
                        <h1 class="dg-print-title mb-0">Income Voucher</h1>
                    </header>
                    ...
                    <div class="card-body dg-card-body py-2 px-3">
                        ...
                        <div class="row g-2 mb-2">
                            ...
                            <div class="col-6">
                                <section class="card dg-card h-100 mb-0">
                                    <header class="card-header dg-card-header py-2">
                                        <h2 class="h6 mb-0">Income Summary</h2>
                                    </header>
                                    <div class="card-body dg-card-body py-2 px-3">
                                        <div class="dg-summary-bar-item">
                                            <span class="dg-summary-bar-label text-muted">Income No</span>
                                            <span class="dg-summary-bar-sep text-muted" aria-hidden="true">:</span>
                                            <span class="dg-summary-bar-value">{{ $income->income_no }}</span>
                                        </div>
                                        <div class="dg-summary-bar-item">
                                            <span class="dg-summary-bar-label text-muted">Financial Year</span>
                                            <span class="dg-summary-bar-sep text-muted" aria-hidden="true">:</span>
                                            <span class="dg-summary-bar-value">{{ $income->financialYear->name ?? '-' }}</span>
                                        </div>
                                        <div class="dg-summary-bar-item">
                                        ...
                                        <div class="dg-summary-bar-item">
                                            ...
                                            <span class="dg-summary-bar-sep text-muted" aria-hidden="true">:</span>
                                            <span class="dg-summary-bar-value">{{ $income->isActive() ? 'Active' : 'Cancelled' }}</span>
                                        </div>
                                    </div>
                                </section>
                            </div>
                        ...
                        <section class="card dg-card mb-2">
                            <header class="card-header dg-card-header py-2">
                                <h2 class="h6 mb-0">Income Details</h2>
                            </header>
                            <div class="card-body dg-card-body py-2 px-3">
                                <div class="row g-2">
                                    <div class="col-6">
                                        <div class="dg-summary-bar-item">
                                            <span class="dg-summary-bar-label text-muted">Title</span>
                                            <span class="dg-summary-bar-sep text-muted" aria-hidden="true">:</span>
                                            <span class="dg-summary-bar-value">{{ $income->title }}</span>
                                        </div>
                                        <div class="dg-summary-bar-item">
                                            <span class="dg-summary-bar-label text-muted">Category</span>
                                            <span class="dg-summary-bar-sep text-muted" aria-hidden="true">:</span>
                                            <span class="dg-summary-bar-value">{{ $income->category->name ?? '-' }}</span>
                                        </div>
                                        <div class="dg-summary-bar-item">
                                            <span class="dg-summary-bar-label text-muted">Account</span>
                                            <span class="dg-summary-bar-sep text-muted" aria-hidden="true">:</span>
                                            <span class="dg-summary-bar-value">{{ $income->account->account_name ?? '-' }}</span>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="dg-summary-bar-item">
                                            ...
                                            <span class="dg-summary-bar-sep text-muted" aria-hidden="true">:</span>
                                            <span class="dg-summary-bar-value fw-bold">{{ number_format($income->amount, 2) }}</span>
                                        </div>
                                        <div class="dg-summary-bar-item">
                                    ...
                                    @if ($income->note)
                                        <div class="col-12">
                                            <div class="dg-summary-bar-item">
                                                ...
                                                <span class="dg-summary-bar-sep text-muted" aria-hidden="true">:</span>
                                                <span class="dg-summary-bar-value">{{ $income->note }}</span>
                                            </div>
                                        </div>
                                    @endif
                                </div>
                        ...
                        <footer class="border-top pt-2 mt-2">
                            <div class="row g-2 text-center small">
                                <div class="col-4">
                                    ...
                                    <div class="fw-bold">{{ $income->createdBy->name ?? '-' }}</div>
                                </div>
                                <div class="col-4">
