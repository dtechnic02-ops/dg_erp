            ...
            <div class="d-flex flex-nowrap align-items-center justify-content-end gap-2">
                <nav class="btn-group" aria-label="Sales invoice toolbar">
                    ...
                    @if ($invoice->due_amount > 0)
                        <a href="{{ route('company.sales-payment.create', $invoice->id) }}" class="btn btn-outline-success dg-btn">Payment</a>
                    @endif
                    @if (
                        ...
                        <a href="{{ route('company.sales-return.create', $invoice->id) }}" class="btn btn-outline-warning dg-btn">Return</a>
                    @endif
                </nav>
            </div>
        </div>
    ...
    <main class="dg-container">
        <div class="container-fluid">
            ...
            <article class="dg-invoice-sheet dg-print">
                ...
                <h1 class="dg-invoice-doc-title">SALES INVOICE</h1>
