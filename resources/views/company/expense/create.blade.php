...
<div class="dg-page">
    ...
    <main class="dg-container">
        <div class="container-fluid">
            ...
            <form method="POST" action="{{ route('company.expense.store') }}" enctype="multipart/form-data" class="dg-form">
                @csrf
                ...
                <section class="dg-section">
                    <article class="card dg-card">
                        ...
                        <div class="card-body dg-card-body">
                            <div class="row g-3">
                                ...
                                <div class="col-md-5">
                                    ...
                                    <input type="text" name="reference_no" id="reference_no" class="form-control dg-input" value="{{ old('reference_no') }}">
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="date" name="expense_date" id="expense_date" class="form-control dg-input" value="{{ old('expense_date', date('Y-m-d')) }}" required>
                                </div>
                                @include('company.components.nepali-date-field', ['adInputId' => 'expense_date', 'adDate' => old('expense_date', date('Y-m-d'))])
                        ...
                        <footer class="card-footer dg-card-footer">
                            <button type="submit" class="btn btn-primary dg-btn">Save Expense</button>
                            <a href="{{ route('company.expense.index') }}" class="btn btn-outline-secondary dg-btn">Cancel</a>
                        </footer>
                    </article>
                </section>
            </form>
