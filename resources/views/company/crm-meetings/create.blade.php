...
<div class="dg-page">
    ...
    <header class="dg-toolbar">
        <div class="container-fluid">
            <div class="row align-items-center g-2">
                <div class="col">
                    <h1 class="h4 mb-0">Schedule Meeting</h1>
                    <p class="text-muted small mb-0">Plan a customer or prospect meeting</p>
                </div>
                <div class="col-auto">
    ...
    <main class="dg-container">
        <div class="container-fluid">
            ...
            <form method="POST" action="{{ route('company.crm-meetings.store') }}" class="dg-form">
                @csrf
                ...
                <section class="dg-section">
                    <article class="card dg-card">
                        ...
                        <div class="card-body dg-card-body">
                            <div class="row g-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="date" name="meeting_date" id="meeting_date" class="form-control dg-input" value="{{ old('meeting_date', date('Y-m-d')) }}" required>
                                </div>

                                <div class="col-md-4">
                                    <label for="meeting_time" class="form-label">Meeting Time</label>
                                    <input type="time" name="meeting_time" id="meeting_time" class="form-control dg-input" value="{{ old('meeting_time') }}">
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="location" id="location" class="form-control dg-input" value="{{ old('location') }}">
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="status" id="status" class="form-select dg-select" required>
                                        @foreach ($statusOptions as $option)
                                            <option value="{{ $option->config_key }}" @selected(old('status', 'scheduled') == $option->config_key)>{{ $option->config_label }}</option>
                                        @endforeach
                                    </select>
                                </div>
                        ...
                        <footer class="card-footer dg-card-footer">
                            <button type="submit" class="btn btn-primary dg-btn">Save Meeting</button>
